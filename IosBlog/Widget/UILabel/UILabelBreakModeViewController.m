...
- (void)viewDidLoad {
    ...
    UILabel* wordWrappingLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 150, 320, 30)];
    ...
    UILabel* charWrappingLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 200, 320, 30)];
    ...
    UILabel* clippingLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 250, 320, 30)];
    ...
    UILabel* truncatingHeadLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 300, 320, 30)];
    ...
    UILabel* truncatingMiddleLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 350, 320, 30)];
    ...
    UILabel* truncatingTailLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 400, 320, 30)];
